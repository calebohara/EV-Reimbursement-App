...
import { isUsingTieredRates, computeTieredDailyCostsMap, computeCostsFromData, getAdditionalCharges } from '../billing.js';
...
export function exportReceiptFromSnapshot(snapshot) {
  ...
  generateReceiptPDF({
    ...
    additionalCharges: snapshot.additionalCharges || [],
...
function generateReceiptPDF(data) {
  const { startDate, endDate, costPerKwh, useTieredRates, dailyCostMap, kwhMap, totalKwh, additionalCharges = [], profileName, start, end } = data;
  ...
  doc.text('Generated by EV kWh Reimbursement App v3.7.2', pageWidth / 2, y, { align: 'center' });
